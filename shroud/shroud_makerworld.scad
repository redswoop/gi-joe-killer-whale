...
// ---------- switches ----------
/* show_ghost: see the top of the file */    // overlay Armen's STL as a translucent reference
/* show_shroud: see the top of the file */
/* show_strut: see the top of the file */
/* show_vanes: see the top of the file */
/* show_fan: see the top of the file */
...
tab_z0 = 1.75;
tab_h  = 5.2;
/* tab_grip: see the top of the file */   // shorten the stem by this much: pulls the hook foot in toward the wall so it
...
/* hinge_pin: see the top of the file */   // "printed" | "filament". Flip in the viewer's panel or with -D 'hinge_pin="filament"'
fil_d        = 1.75;   // filament pin diameter
/* fil_clr: see the top of the file */   // hole clearance on the filament, per side. Coupon (2026-09-12): 0.10 / 0.15 / 0.20 printed, 0.15 the best fit
...
/* vane_mount: see the top of the file */   // "teeth" (loose vanes on teeth, ny_mount picks the -Y one) | "fused" (bars part of the shroud; see the
                          // FUSED block below). Flip in the viewer's panel or with -D 'vane_mount="fused"'
fused        = vane_mount == "fused";
/* fused_canoes: see the top of the file */      // fused: keep the canoes as fairings over the posts (the -Y dart, the +Y pod with its bore-side half and
...
// tooth_clr_eff / tooth_lead_eff (the fused overrides) are set below, after tooth_clr and tooth_lead exist.
...
/* hinge_clr: see the top of the file */   // pin-to-hole clearance, per side. Coupon round 1: 0.35 and 0.45 good, 0.25 not;
...
/* tie_eye_clr: see the top of the file */   // working hole clearance per side on the pin
...
slat_t        = 2;    slat_rod_d = 2;  /* slat_clr: see the top of the file */       // rod = plate thickness so it prints flat; hole = rod + 2*clr.
...
/* tooth_clr: see the top of the file */   // slot to wall, per face (radial). Coupon round 3 (2026-09-12): 0.10 / 0.15 / 0.20 printed, 0.10 the best fit
...
/* ny_mount: see the top of the file */   // "fork" | "saddle". Flip in the viewer's panel or with -D 'ny_mount="saddle"'
...
/* fin_print: see the top of the file */    // how the separate plate prints: "edge" = standing on its long outer edge (the one opposite the hinge),
...
/* slat_fil_clr: see the top of the file */      // slat barrel hole clearance on the filament axle, per side (snugger than the bar's fil_clr:
...
/* ear_clr: see the top of the file */              // ear to pocket, per face (coupon: 0.1 / 0.2 / 0.3)
...
/* blade_hand: see the top of the file */                                // +1: leading edge on the counter-clockwise side seen from +Z (the exit); -1 mirrors.
...
/* shaft_clr: see the top of the file */                             // socket clearance on the shaft, per side (untested)
...
/* shaft_extra: see the top of the file */                                // Armen: the reference is too short; add this much (TBD from the print)
...
//  assembly
// =====================================================================
// ---------- assembly preview (part = "assembly") ----------
module assembly() {
